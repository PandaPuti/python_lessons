with open("file_name","r") as file1:
  ...
  print(file_stuff)
print(file1.closed())
print(file_stuff) #accessible anywhere

with open("file_name","r"):
				file_stuff = file1.readlines()

This will give the list of  lines of the file as in python file content is saved as ['This is line 1\n','This is line2\n']

file_stuff[0] = This is line1
file_stuff[1] = This is line2

file_stuff = file1.readline()  will give first line of the file 
file_stuff = file1.readline() now it will give second line of the file

we use loop to print each line 
with open("file_name","r") as file1:
  for line in file1:
    print(line)
